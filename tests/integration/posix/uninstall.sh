...
uninstall_started_message='Uninstall started. Cleanup will finish automatically after this command exits.'
...
assert_contains "$output" "PATH was not changed. If cleanup fails, cup data remains at '"
